<?php 
    ...
    $recipe_id = json_decode($raw_data,true);
    

    $query_comment = "SELECT * FROM comment_reply WHERE recipe_id = '$recipe_id' AND parent_comment_id IS NULL";
        ...
        <div class="comment-body">
            ...
            <div class="comment-reply-container">
                ...
                <?php 
                    ...
                    $query_reply = "SELECT * FROM comment_reply WHERE recipe_id = '$recipe_id' AND parent_comment_id IS NOT NULL";
                    ...
                    if($replies["parent_comment_id"] == $comments["id"]){
                ?>
