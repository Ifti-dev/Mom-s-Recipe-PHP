<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($recipe_id)){
            ...
            if(!empty($_FILES["recipe-form-file"]) and $_FILES["recipe-form-file"]["name"][0] != ""){
                ...
                echo json_encode(["uribaba" => "ffafaf"]);
            }
            else if(empty($_FILES["recipe-form-file"])){
                ...
                echo json_encode(["uribaba" => "success"]);
            }
        }
